...
| fraction                      | ein Bruch                         | une fraction                  | 分数        |
| numerator                     | der Zähler                        | le numérateur                 | 分子        |
| denominator                   | der Nenner                        | le dénominateur               | 分母        |
...
| method, member function  | eine Methode             | une méthode                  | メソッド              |
| constructor              | ein Konstructor          | un constructeur              | コンストラクタ           |
| inheritance              | die Vererbung            | l’héritage                   | 継承              |
| polymorphism             | die Polymorphie          | le polymorphisme             | ポリモーフィズム          |
| encapsulation            | die Datenkapselung       | l’encapsulation              | カプセル化            |
| function                 | eine Funktion            | une fonction                 | 関数              |
| regular expression       | ein regulärer Ausdruck   | une expression régulière     | 正規表現          |
| enumeration              | eine Aufzählung          | une énumération              | 列挙型            |
| overloading              | ein Überladen            | la surcharge                 | オーバーロード, 多重定義 |
| standard streams (stdio) | die Standard-Datenströme | les flux standard            | 標準ストリーム         |
...
| semantics                | die Semantik             | la sémantique                | 意味論            |
| grammar                  | die Grammatik            | la grammaire                 | 文法              |
| compiler                 | ein Compiler             | un compilateur               | コンパイラ             |
